...
- Diseñar una infraestructura modular orientada a soportar servicios tecnológicos para empresas.
- Simular dicha infraestructura utilizando herramientas de virtualización y contenedores.
- Integrar servicios fundamentales relacionados con red, bases de datos, autenticación, monitorización, seguridad y almacenamiento.
- Organizar el proyecto de forma estructurada, aplicando metodologías de trabajo reconocidas.
- Consolidar conocimientos técnicos y demostrar la capacidad de diseñar soluciones completas en un entorno controlado.

# 5. Finalidad y beneficios
